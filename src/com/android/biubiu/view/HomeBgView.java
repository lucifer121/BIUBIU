...
public class HomeBgView extends RelativeLayout{
	...
	public void setMoonAnimin(){
		...
		ObjectAnimator anim3 = ObjectAnimator.ofFloat(moovImv, "x",width*172/360, width*258/360);
		ObjectAnimator anim4 = ObjectAnimator.ofFloat(moovImv, "y", width*350/360,width*280/360);
		ObjectAnimator anim5 = ObjectAnimator.ofFloat(moovImv, "x", width*258/360,width*278/360);
		ObjectAnimator anim6 = ObjectAnimator.ofFloat(moovImv, "y", width*280/360,width*18/360);
		ObjectAnimator anim7 = ObjectAnimator.ofFloat(moovImv, "x", width*278/360,width*120/360);
		...
		anim3.setDuration(1000*12);
		anim4.setDuration(1000*12);
		anim5.setDuration(1000*30);
		anim6.setDuration(1000*30);
		anim7.setDuration(1000*10);
		anim8.setDuration(1000*10);
		anim9.setDuration(1000*25);
		anim10.setDuration(1000*25);
		anim11.setDuration(1000*22);
		anim12.setDuration(1000*22);
	...
	private void setSunAnimin() {
		...
		anim1.setDuration(1000*15);
		anim2.setDuration(1000*15);
		...
		anim7.setDuration(1000*10);
		anim8.setDuration(1000*10);
		anim9.setDuration(1000*15);
		anim10.setDuration(1000*15);
		anim11.setDuration(1000*15);
		anim12.setDuration(1000*15);
		anim13.setDuration(1000*35);
		anim14.setDuration(1000*35);
