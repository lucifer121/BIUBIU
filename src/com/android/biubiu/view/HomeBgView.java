...
public class HomeBgView extends RelativeLayout{
	...
	public void setMoonAnimin(){
		ObjectAnimator anim1 = ObjectAnimator.ofFloat(moovImv, "x",width*10/360, width*172/360);
		ObjectAnimator anim2 = ObjectAnimator.ofFloat(moovImv, "y", width*510/360,width*350/360);
		ObjectAnimator anim3 = ObjectAnimator.ofFloat(moovImv, "x", width*172/360,width*248/360);
		ObjectAnimator anim4 = ObjectAnimator.ofFloat(moovImv, "y", width*350/360,width*18/360);
		ObjectAnimator anim5 = ObjectAnimator.ofFloat(moovImv, "x", width*248/360,width*120/360);
		ObjectAnimator anim6 = ObjectAnimator.ofFloat(moovImv, "y",width*18/360,width*23/360);
		ObjectAnimator anim7 = ObjectAnimator.ofFloat(moovImv, "x", width*120/360,width*33/360);
		ObjectAnimator anim8 = ObjectAnimator.ofFloat(moovImv, "y", width*23/360,width*224/360);
		ObjectAnimator anim9 = ObjectAnimator.ofFloat(moovImv, "x", width*33/360,width*10/360);
		ObjectAnimator anim10 = ObjectAnimator.ofFloat(moovImv, "y", width*224/360,width*554/360);
		anim1.setDuration(1000*20);
		anim2.setDuration(1000*20);
		anim3.setDuration(1000*35);
		anim4.setDuration(1000*35);
		anim5.setDuration(1000*10);
		anim6.setDuration(1000*10);
		anim7.setDuration(1000*25);
		anim8.setDuration(1000*25);
		anim9.setDuration(1000*30);
		anim10.setDuration(1000*30);
		animMoonSet.play(anim1).with(anim2);
		animMoonSet.play(anim3).after(anim1);
		animMoonSet.play(anim3).with(anim4);
		animMoonSet.play(anim5).after(anim3);
		animMoonSet.play(anim5).with(anim6);
		animMoonSet.play(anim7).after(anim5);
	...
	private void setSunAnimin() {
		...
		ObjectAnimator anim12 = ObjectAnimator.ofFloat(sunImv, "y", width*8/360,width*210/360);
		ObjectAnimator anim13 = ObjectAnimator.ofFloat(sunImv, "x", width*29/360,width*144/360);
		ObjectAnimator anim14 = ObjectAnimator.ofFloat(sunImv, "y", width*210/360,width*500/360);
