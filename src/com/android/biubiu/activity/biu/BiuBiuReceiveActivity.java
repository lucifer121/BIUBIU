		...
		x.http().post(params, new CommonCallback<String>() {
			...
			public void onSuccess(String arg0) {
				...
				try {
					...
					// sex=(TextView) findViewById(R.id.sex_receive_biu_tv);
					// school=(TextView)
					// findViewById(R.id.school_receive_biu_tv);
					// starsign=(TextView)
					// findViewById(R.id.starsign_receive_biu_tv);
					//
					// numberInTag=(TextView)
					// findViewById(R.id.number_in_personalTag_tv);
					// numberInInterestTag=(TextView)
					// findViewById(R.id.number_interestTag_receive_biu_tv);
